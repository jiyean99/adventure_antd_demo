...
const MDivideBoard: React.FC = () => {
  ...
  return (
    <div className="MDivideBoard">
      <button className='n-l-btn'>
      ...
      <div className='d-b-board'>
        <div>
          ...
          <button type={'button'} className='d-b-icon2' id='test1'>
        ...
        <div>
          ...
          <Radio.Group  onChange={onChange} buttonStyle="solid" className='d-b-btn-group'>
            ...
            <Radio.Button value="8" className='d-b-btn accodian' disabled>
